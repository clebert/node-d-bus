...
describe('MessageParser', () => {
  test('parse incomplete messages', () => {
    ...
    expect(messageParser.parseMessages(validData.slice(0, 10))).toEqual(
      undefined
    );

    expect(messageParser.parseMessages(validData.slice(10, 100))).toEqual(
      undefined
    );
    ...
    expect(messageParser.parseMessages(invalidData.slice(0, 10))).toEqual(
      undefined
    );
